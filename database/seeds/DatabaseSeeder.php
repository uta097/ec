...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::insert("INSERT into items (name,img,description,price) VALUES (?,?,?,?)",[
            "ようかん",
            "https://cdn-ak.f.st-hatena.com/images/fotolife/b/b7015/20181120/20181120160145.jpg",
            "伝統の味はそのままに、気軽にお楽しみ頂ける一口サイズに仕上げました",
            "200"
        ]);
        DB::insert("INSERT into items (name,img,description,price) VALUES (?,?,?,?)",[
            "まんじゅう",
            "https://cdn-ak.f.st-hatena.com/images/fotolife/b/b7015/20181120/20181120160147.jpg",
            "甘すぎない上品な味わいはご年配の方を含め様々な方に愛されています",
            "300"
        ]);
        DB::insert("INSERT into items (name,img,description,price) VALUES (?,?,?,?)",[
            "どらやき",
            "https://cdn-ak.f.st-hatena.com/images/fotolife/b/b7015/20181120/20181120160150.jpg",
